...
<section id="profil" class="relative min-h-screen flex items-center px-6 md:px-20 py-32">
    <div class="max-w-2xl ml-auto w-full pr-10">
        ...
        <div data-animate data-delay="0.3"
            class="space-y-5 border-l-2 border-r-2 border-cyan-400/30 pl-6 translate-x-8 opacity-0 transition-all duration-500">
...
<section id="competences" class="relative px-6 md:px-20 py-32">
    ...
    <div class="flex flex-wrap justify-center gap-5 md:gap-8 max-w-4xl mx-auto">
        ...
        foreach ($skills as $index => $skill):
            $color = $skill['color'];
        ?>
            <div class="skill-bubble relative w-28 h-28 md:w-32 md:h-32 shrink-0 flex items-center justify-center cursor-pointer">
                <!-- Bulle -->
