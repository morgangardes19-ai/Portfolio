...
<body class="relative flex flex-col px-4 bg-bg-page-tempo">
    <header class="fixed flex flex-row gap-32 items-center justify-between border border-border-header rounded-[50px] backdrop-blur-xl top-4 left-4 right-4 px-4">
        <!-- Ici : photo de profil -->
        ...
        <nav class="flex lg:hidden flex-row gap-2 ">
            ...
            <div id="overlay-burger" class="fixed transition-all duration-300 translate-x-full top-16.5 right-0 flex flex-col items-center gap-6 px-16 py-14 text-boutons-header text-[16px] inter-regular bg-black/80 rounded-md tracking-[10%] text-center">
