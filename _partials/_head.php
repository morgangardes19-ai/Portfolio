...
<body class="flex flex-col px-4 bg-bg-page-tempo">
    <header class="fixed flex flex-row gap-32 items-center justify-between border border-border-header rounded-[50px] w-full backdrop-blur-xl">
        <!-- Ici : photo de profil -->
        ...
        <nav class="flex lg:hidden flex-row gap-2">
            ...
            <div id="overlay-burger" class="fixed transition-all duration-300 translate-x-full top-16.5 right-0 flex flex-col items-center gap-6 px-16 py-14 text-boutons-header text-[16px] ibm-plex-mono-regular bg-black/95 rounded-md tracking-[10%] text-center">
